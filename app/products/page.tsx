...
export const metadata: Metadata = {
  ...
  description:
    "Buy digital products from DoyinTech: WhatsApp quote kits, Status calendars, growth packs, trackers, and freelancer systems. Pay with Paystack.",
};
      ...
      <main className="bg-black pt-20">
        <div className="mx-auto max-w-[980px] px-6 pb-4 text-center">
          ...
          <p className="apple-subhead mx-auto mt-4 max-w-2xl">
            Digital packs for freelancers and SMEs — including today’s WhatsApp Quote &amp; Last-Price
            Kit. Secure checkout with Paystack; delivery by download after payment.
          </p>
        </div>
        <PassiveProducts />
        <LeadMagnet />
