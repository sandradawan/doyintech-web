...
export const DIGITAL_PRODUCTS: DigitalProduct[] = [
  {
    ...
    features: [
      ...
      "Dark/orange branding tips",
    ],
    delivery: "Instant download — Sheets setup guide + CSV layouts",
  ...
  },
  {
    ...
    features: [
      ...
      "Dashboard counts & pipeline value",
    ],
    delivery: "Instant download — Sheets setup guide",
